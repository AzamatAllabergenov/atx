        ...
        <div class="card">
            ...
            <div class="card-body">
				...
				{!! Form::open(['files' => true]) !!}
					...
					<div class="form-group">
						{!! Form::label('feature_group_id', 'Группа') !!}
						{!! Form::select('feature_group_id', $groups, $item ? $item->feature_group_id : null, [
							'class' => 'form-control'
						]) !!}
					</div>
					
					<button type="submit" class="btn btn-primary">Сохранить</button>
					<a href="{{ action('Backend\FeatureController@index') }}" class="btn btn-outline-primary">
