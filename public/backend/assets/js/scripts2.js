  ...
  NioApp.CurrentLink = function () {
    ...
    $(_link).each(function () {
      ...
      if (fileName.match(_self_link)) {
        self.closest("li").addClass('current-page').parents().closest("li").addClass("active current-page");
    ...
    if ($(elm).exists()) {
      $(elm).each(function () {
        ...
        var def = {
          ...
          language: {
            search: "",
            searchPlaceholder: "Қидириш учун ёзинг",
            lengthMenu: "<span class='d-none d-sm-inline-block'>Кўрсатиш</span><div class='form-control-select'> _MENU_ </div>",
            info: "_START_-_END_ гача _TOTAL_ та дан",
            infoEmpty: "Ҳеч қандай маълумот топилмади",
